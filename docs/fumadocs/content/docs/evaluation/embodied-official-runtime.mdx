...
<KvCatalog heading="Benchmark" vars rows={[
    ...
    { name: <><code>libero-para</code></>, description: <><code>WORLDFOUNDRY_LIBERO_PARA_SPLIT</code></>, reads: [{ label: "Policy checkpoint", value: <><code>WORLDFOUNDRY_LIBERO_PARA_POLICY_CHECKPOINT</code></> }, { label: "Official results", value: <><code>WORLDFOUNDRY_LIBERO_PARA_RESULTS_PATH</code></> }] },
