...
export const WORLDFOUNDRY_GITHUB_ISSUES = `${WORLDFOUNDRY_GITHUB_REPO}/issues`;
export const WORLDFOUNDRY_GITHUB_DISCUSSIONS = `${WORLDFOUNDRY_GITHUB_REPO}/discussions`;
export const WORLDFOUNDRY_SLACK_INVITE =
