"""Kairos Sensenova 4B 720P checkpoint-backed GPU inference probe."""
...
root = Path("tmp/kairos-720p-gpu-20260924")
root.mkdir(parents=True, exist_ok=True)
ckpts = Path("../ckpts").resolve()
model_root = ckpts / "kairos-agi--kairos-sensenova-4B-720P"
...
try:
    ...
    dit = model_root / "kairos-common-4B-720P.safetensors"
