...
root = Path("tmp/kairos-robot-gpu-20260924")
root.mkdir(parents=True, exist_ok=True)
ckpts = Path("../ckpts").resolve()
model_root = ckpts / "kairos-agi--kairos-sensenova-robot-4B-480P-distilled"
...
try:
    ...
    dit = model_root / "kairos-robot-4B-480P-distilled.safetensors"
    ...
    output = runtime.predict(
        prompt="A robot arm reaches toward a small turquoise toy on a plate on a red table.",
        images=str(source),
