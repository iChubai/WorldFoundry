...
"""Optional Triton RMSNorm kernel for DC-AE.

:class:`TritonRMSNorm2dFunc` is the autograd Function used
by :class:`~.norm.TritonRMSNorm2d` when Triton is available.
Otherwise :mod:`.norm` falls back to PyTorch RMSNorm.

Tensors are BCHW feature maps inside DC-AE stages.

This is an optional kernel, not a codec entry point.
"""
...
def _rms_norm_2d_fwd_fused(
    ...
    """Helper function to rms norm 2d fwd fused.
...
def _rms_norm_2d_bwd_dx_fused(
    ...
    """Helper function to rms norm 2d bwd dx fused.
    ...
    Args:
        ...
        num_blocks: The num blocks.
        eps: The eps.
        GROUP_SIZE_M: The group size m.
        BLOCK_SIZE: The block size.
        BLOCK_SIZE_C: The block size c.
    """
...
class TritonRMSNorm2dFunc(torch.autograd.Function):
    """Triton rms norm d func implementation."""
    @staticmethod
