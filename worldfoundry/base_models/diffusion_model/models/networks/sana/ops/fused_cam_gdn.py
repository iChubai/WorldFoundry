...
This is the CamCtrl counterpart of :mod:`fused_gdn`: it fuses RMSNorm / ReLU /
UCPE 4×4 / RoPE for the *camera* QKV, then the chunkwise scan in
``fused_gdn_chunkwise`` consumes the prepared tensors.
