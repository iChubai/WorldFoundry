...
UCPE (Unified Camera Pose Embedding) turns per-frame pose + UCM intrinsics
into per-pixel ray matrices that transform camera-branch Q/K/V.  The dual
GDN+UCPE blocks themselves live in ``sana_gdn_camctrl_blocks``.
