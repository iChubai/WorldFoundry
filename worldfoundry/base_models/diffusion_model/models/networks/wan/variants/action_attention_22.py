"""Flash-attention dispatcher used by Wan 2.2 action transformers.

Same backend selection as :mod:`.action_attention_21` for the 2.2 action
graph.  Kernel adapter only.
"""
import torch
try:
