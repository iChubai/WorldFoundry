...
"""DreamZero flash-attention dispatcher (Wan 2.1 kernels).

Kernel adapter for DreamZero blocks.  No action math here.
"""
import contextlib
import torch
...
class AttentionModule(torch.nn.Module):
    """DreamZero packed-sequence attention wrapper."""
    def __init__(
        self,
        num_heads: int,
        head_dim: int,
