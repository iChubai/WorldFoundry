...
"""Flash-attention dispatcher used by Krea realtime Wan.

Kernel adapter for Krea blocks.  SageAttention is :mod:`.krea_sage`.
"""
import torch
try:
...
from .krea_sage import sageattn_func, SAGEATTN_AVAILABLE
...
def flash_attention(
    ...
    """
    if not FLASH_ATTN_3_AVAILABLE and q_lens is None and k_lens is None:
        assert FLASH_ATTN_2_AVAILABLE and flash_attn_2_func is not None
        return flash_attn_2_func(
            q,
            k,
            v,
            dropout_p=dropout_p,
