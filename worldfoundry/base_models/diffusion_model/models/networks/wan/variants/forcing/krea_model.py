...
"""Krea realtime bidirectional Wan stem.

Official-layout building block for :mod:`.krea`.  No causal cache here.
"""
import math
...
from .krea_attention import flash_attention, sageattn_func, SAGEATTN_AVAILABLE, FLASH_ATTN_2_AVAILABLE, FLASH_ATTN_3_AVAILABLE
...
class WanModel(nn.Module, NativeConfigMixin):
    r"""Krea realtime bidirectional Wan stem."""
