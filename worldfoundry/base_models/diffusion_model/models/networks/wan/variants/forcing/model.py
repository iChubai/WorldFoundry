...
"""Bidirectional Wan stem shared by Self-Forcing recipes.

Official-layout Wan used as the teacher / bidirectional backbone.
Causal forcing graphs are :mod:`.self_forcing` and :mod:`.causal_forcing`.
"""
import math
...
class WanModel(nn.Module, NativeConfigMixin):
    r"""Bidirectional Wan stem shared by Self-Forcing recipes."""
