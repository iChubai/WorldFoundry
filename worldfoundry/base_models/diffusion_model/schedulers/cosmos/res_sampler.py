...
from worldfoundry.base_models.diffusion_model.schedulers.cosmos.multi_step import (
    get_multi_step_fn,
...
class Sampler(torch.nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            S_max: The s max.
            S_noise: The s noise.
            solver_option: The solver option.
        ...
        def float64_x0_fn(x_B_StateShape: torch.Tensor, t_B: torch.Tensor) -> torch.Tensor:
            ...
            Args:
                x_B_StateShape: The x b stateshape.
                t_B: The t b.
