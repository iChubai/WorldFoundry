...
@dataclass
class EvokeSchedulerOutput(BaseOutput):
...
class EvokeScheduler(SchedulerMixin, ConfigMixin):
    _compatibles = []
    order = 1
    ...
    def step_euler(
        ...
        return EvokeSchedulerOutput(prev_sample=prev_sample)
    ...
    multistep_uni_p_bh_update = FlowUniPCMultistepScheduler.multistep_uni_p_bh_update

    multistep_uni_c_bh_update = FlowUniPCMultistepScheduler.multistep_uni_c_bh_update
