...
# changing the environment variable `TRAINER_NCCL_SO_PATH`, or the `so_file`
# variable in the code.

# TODO(will): support TRAINER_NCCL_SO_PATH
...
from ..cuda_utils import find_nccl_library
...
class NCCLLibrary:
    ...
    exported_functions = [
        ...
        Function(
            "ncclAllGather",
            ncclResult_t,
            [buffer_type, buffer_type, ctypes.c_size_t, ncclDataType_t, ncclComm_t, cudaStream_t],
        ),
        ...
        Function(
            "ncclBroadcast",
            ncclResult_t,
            [buffer_type, buffer_type, ctypes.c_size_t, ncclDataType_t, ctypes.c_int, ncclComm_t, cudaStream_t],
        ),
    ...
    def __init__(self, so_file: str | None = None):
        ...
        try:
            ...
            logger.error(
                ...
                "environment variable TRAINER_NCCL_SO_PATH"
