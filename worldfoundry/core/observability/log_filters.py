...
:func:`worldfoundry.core.observability.logging_setup.configure_logging`, which is
...
here; those belong in :mod:`worldfoundry.core.observability.logging_setup`.
"""
...
def install_inductor_autotune_demote() -> None:
    ...
    because :mod:`worldfoundry.core.observability.log_filters` was re-imported during a
