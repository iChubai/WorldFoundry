    ...
    for prompt_dict in tqdm(prompt_dict_ls):
        ...
        for video_path in video_paths:
            ...
            for i in range(len(base_question)):
                ...
                prompt_text = f"""Watch the video carefully and answer the following question about the spatial relationship and position in the video:
...
def compute_dynamic_spatial_relationship(json_dir, device, submodules_dict, **kwargs):  
    _, prompt_dict_ls = load_dimension_info(json_dir, dimension='alignment_relationship_control', lang='en')
