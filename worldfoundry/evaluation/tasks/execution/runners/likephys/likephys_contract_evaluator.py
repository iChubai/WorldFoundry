"""Benchmark-zoo contract evaluator for LikePhys."""
...
from worldfoundry.evaluation.tasks.execution.runners.likephys.likephys_official_filter import (
    BENCHMARK_ID,
    OFFICIAL_REQUIREMENTS,
    filter_official_records,
)
from worldfoundry.evaluation.tasks.execution.runners.likephys.likephys_official_scoring import (
    official_scores_from_records,
)

EVALUATOR_KIND = "in_tree_likephys_contract_evaluator"


def write_likephys_evaluation(
    *,
    display_name: str,
    ...
    **kwargs: Any,
    ...
    return write_video_contract_evaluation(
        ...
        prompt_manifest_keys=("likephys_scenario_manifest",),
...
__all__ = ["EVALUATOR_KIND", "write_likephys_evaluation"]
