...
from worldfoundry.base_models.perception_core.video_text.blip2_feature_extractor import load_blip2_feature_extractor
...
def gender_bias_blip(retina_model, video_dict, device):
    ...
    model, vis_processors, txt_processors = load_blip2_feature_extractor(device=device)
...
def compute_gender_bias(json_dir, device, submodules_list):
    ...
    retina_state_dict = load_retinaface_state_dict(submodules_list["retina"], map_location="cpu")
