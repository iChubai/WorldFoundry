"""Inception I3D backbone used by FVD/KVD feature extraction.

Single in-tree copy of the pytorch-i3d network definition
(https://github.com/piergiaj/pytorch-i3d). Benchmark runtimes that need the
backbone (e.g. MiraBench) import it from here instead of vendoring their own
copy; ``runners/mirabench/runtime/mirabench/evaluation/pytorch_i3d.py`` is a
thin re-export shim kept for official-protocol import compatibility.
"""
import numpy as np
