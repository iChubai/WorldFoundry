"""Multi-Scale SSIM pairwise structural similarity (torchmetrics backend)."""
...
def compute_ms_ssim(
    ...
    *,
    ...
    metric = MultiScaleStructuralSimilarityIndexMeasure(data_range=data_range).to(device_t)
