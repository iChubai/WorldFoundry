"""Ltx2 3 I2V visual generation pipeline module."""
...
class LTX23I2VPipeline(PipelineABC):
    ...
    def get_operator(self) -> RuntimeVideoOperator:
        """Get operator for LTX23I2VPipeline."""
        return self.operator

    def get_synthesis_model(self):
        """Get synthesis model for LTX23I2VPipeline."""
