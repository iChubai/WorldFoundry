...
class Pi3Result:
    ...
    """Result container representing outputs of Pi3 pipeline execution."""
    def __init__(
        self,
...
class Pi3Pipeline(PipelineABC):

    """Pipeline implementation for Pi3 visual generation."""
    def __init__(
        self,
