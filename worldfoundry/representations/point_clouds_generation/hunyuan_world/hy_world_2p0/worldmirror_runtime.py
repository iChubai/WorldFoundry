"""
WorldMirror 2.0 runtime adapter for HY-World 2.0 reconstruction.

Typical WorldFoundry usage:
    from worldfoundry.pipelines.hunyuan_world.pipeline_hy_world_2p0 import HYWorld2Pipeline

    pipe = HYWorld2Pipeline.from_pretrained("tencent/HY-World-2.0")
    output_dir = pipe(input_path="path/to/images_or_video")
"""
...
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.models.models.worldmirror import WorldMirror
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.models.layers.block import Block, DistBlock
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.models.heads.dense_head import DPTHead
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.models.heads.camera_head import CameraHead
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.utils.inference_utils import (
...
from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.utils.scene_render import (
...
def _collect_fp32_critical_modules(model):
    from worldfoundry.base_models.three_dimensions.point_clouds.hyworldmirror_2p0.models.layers.mlp import MlpFP32
    critical = set()
...
class WorldMirrorPipeline:
    """HY-World 2.0 WorldMirror inference pipeline.
        ...
        *,
        ...
        if is_distributed:
            ...
            if use_fsdp:
                ...
                use_fsdp = False
            print(f"[Pipeline] Single-GPU mode on {device}")
...
def main():
    parser = argparse.ArgumentParser(description="HY-World 2.0 WorldMirror Pipeline")
