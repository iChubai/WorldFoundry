...
from worldfoundry.base_models.three_dimensions.point_clouds.loger.pi3 import Pi3
from worldfoundry.base_models.three_dimensions.point_clouds.loger.utils.geometry import depth_edge
...
class LoGeRRepresentation(BaseRepresentation):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        checkpoint = load_torch_checkpoint(ckpt_file, map_location="cpu", weights_only=False)
        state_dict = (
