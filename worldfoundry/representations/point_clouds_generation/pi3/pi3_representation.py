...
from worldfoundry.base_models.three_dimensions.point_clouds.pi3_inference.models.pi3 import Pi3
...
class Pi3Representation(BaseRepresentation):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        try:
            model = Pi3.from_pretrained(pretrained_model_path, strict=True)
        except Exception:
