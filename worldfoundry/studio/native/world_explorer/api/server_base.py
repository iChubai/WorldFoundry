...
ROOT_DIR = realpath(
	os.environ.get(
		"WORLDFOUNDRY_EXPLORER_RUNTIME_ROOT",
...
class InferenceModel():
	"""Base class for a world model running in the native viewer process."""

	def __init__(self, data_path: str | None = None, checkpoint_path: str | None = None,
				 fake_delay_ms: float = 0, inference_cache_size: int = 15) -> None:

		# These paths may be unused by a given model adapter.
	...
	def metadata(self) -> dict:
		"""Returns metadata about this inference model."""
