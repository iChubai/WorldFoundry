...
public:
	...
	bool reprojection_available() { return m_reproject_enable; }
...
#	endif
	...
	// ---------- World Explorer GUI state
	/**
	 * Common signature for model-backend UI callback functions, to be implemented
	 * in Python.
	 *
	 * Inputs:
	...
	// Info string to be displayed in the backend UI window.
