...
"""Alignment resamplers retained for checkpoint-compatible inference."""
...
from worldfoundry.base_models.diffusion_model.models.encoders.lvdm.resampler import PerceiverAttention
