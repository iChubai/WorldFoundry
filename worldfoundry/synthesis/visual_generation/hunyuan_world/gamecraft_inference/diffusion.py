...
from .pipeline import HunyuanVideoGamePipeline


def load_diffusion_pipeline(
    args, rank, vae, text_encoder, text_encoder_2, model, scheduler=None, device=None, progress_bar_config=None
):
    """Load the denoising scheduler for inference."""
    if scheduler is None:
        scheduler = FlowMatchDiscreteScheduler(
            shift=getattr(args, "flow_shift_eval_video", 5.0),
    ...
    pipeline = HunyuanVideoGamePipeline(
        vae=vae,
