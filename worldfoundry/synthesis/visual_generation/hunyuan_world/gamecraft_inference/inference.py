...
from .constants import PRECISION_TO_TYPE, PROMPT_TEMPLATE, VAE_PATH
...
class Inference(object):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_path, model_base, args, device=None, **kwargs):
        """
        ...
        if args.use_fp8:
            raise ValueError("GameCraft FP8 conversion is not supported by this runtime.")

        # ============================= Build extra models ========================
        # VAE
        print("=" * 25, "load vae", "=" * 25)
