...
#
# ==============================================================================
"""Deprecated compatibility base used only by legacy HunyuanWorld derivatives.

Canonical HunyuanVideo models use ``NativeDiffusionPipeline`` and never import
this module.  GameCraft and Voyager retain it until their custom loops are
expressed as native recipes.
"""
...
from worldfoundry.base_models.diffusion_model.models.encoders.hunyuan_video.constants import (
    PRECISION_TO_TYPE,
)
from worldfoundry.base_models.diffusion_model.models.encoders.hunyuan_video.original import (
    TextEncoder,
)
from worldfoundry.base_models.diffusion_model.models.networks.hunyuan_video import (
    HunyuanVideoDiT as HYVideoDiffusionTransformer,
)
...
class HunyuanVideoPipelineOutput(BaseOutput):
    """Hunyuan video pipeline output implementation."""
...
class HunyuanVideoPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        Args:
            ...
            progress_bar_config: The progress bar config.
            args: The args.
        """
        super().__init__()
    ...
    def decode_latents(self, latents, enable_tiling=True):
        ...
        Args:
            latents: The latents.
            enable_tiling: The enable tiling.
        """
    ...
    def check_inputs(
        ...
        Args:
            ...
            callback_steps: The callback steps.
