...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    time_embedding_weight = next(dit.time_embedding.parameters())
    timestep_embedding = sinusoidal_embedding_1d(dit.freq_dim, timestep).to(
        dtype=time_embedding_weight.dtype,
        device=time_embedding_weight.device,
    )
    t = dit.time_embedding(timestep_embedding)
