...
def load_model_bidirectional(transformer_dir):
    from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_worldplay.models.transformers.ar_action_hunyuanvideo_1_5_transformer import (
...
def load_model_prope(transformer_dir, use_discrete_action=False):
    ...
    from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_worldplay.models.transformers.ar_action_hunyuanvideo_1_5_prope_transformer import (
        ARHunyuanVideo_1_5_DiffusionTransformer,
    )
...
def main():
    ...
    # ── Load encoders ONCE ──
    from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_worldplay.models.autoencoders.hunyuanvideo_15_vae_w_cache import (
        AutoencoderKLConv3D,
    )
    ...
    from worldfoundry.synthesis.visual_generation.hunyuan_world.hunyuan_worldplay.runtime import (
        _HunyuanWorldPlayInternalPipeline as HunyuanVideo_1_5_Pipeline,
    )
