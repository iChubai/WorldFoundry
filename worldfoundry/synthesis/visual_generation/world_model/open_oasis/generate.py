...
device = os.environ.get("WORLDFOUNDRY_DEVICE") or ("cuda:0" if torch.cuda.is_available() else "cpu")
...
def main(args):
    ...
    with torch.no_grad():
        with autocast(device_type, dtype=torch.half, enabled=device_type == "cuda"):
